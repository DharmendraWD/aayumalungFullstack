...
console.log(email, password, username)
  ...
  <div className="relative h-screen bg-gray-50">
    <div
        className="absolute top-20 left-2 w-[500px] h-[500px] pointer-events-none bg-[#D1208A80] rounded-full mix-blend-multiply filter blur-[150px] opacity-70 animate-blob">
    </div>
    <div
    ...
    <div
        className="hidden xl:block absolute bottom-10 left-32 z-[-1] w-[500px] h-[500px] bg-[#FFB20080] rounded-full mix-blend-multiply filter blur-[150px] opacity-70 animate-blob animation-delay-4000">
    </div>
    <div
